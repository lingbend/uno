...
while True:
    # Render the cards
    clickable_cards, deck_rect, red_rect, yellow_rect, green_rect, blue_rect, confirm = render.render(w, g)

    # Get Input (with update inside)
    for event in pygame.event.get():
        if event.type == pygame.MOUSEBUTTONDOWN:
            update.update(g, event, clickable_cards, deck_rect, red_rect, yellow_rect, green_rect, blue_rect, confirm)
